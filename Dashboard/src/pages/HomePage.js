  ...
  return (
    <div className='min-h-100vh flex grow bg-slate-50 dark:bg-navy-900'>
      ...
      <div className='sidebar print:hidden'>
        {/* Sidebar Panel */}
        <div className={sidebarExpanded ? 'is-sidebar-open ' : 'sidebar-panel'}>
            ...
            >
              <ul className='flex flex-1 flex-col px-4 font-inter'>
                <li x-data="accordionItem('menu-item-1')">
                  <a
                    // :className="expanded && 'text-slate-800 font-semibold dark:text-navy-50'"
                    // @click="expanded = !expanded"
                    className='flex items-center justify-between py-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50'
                  ...
                  <ul x-collapse x-show='expanded'>
                    <li>
                      <a
                        ...
                        // :className="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-500 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50'"
